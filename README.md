# 🇧🇷 SolidSign API - Exemplo de Integração: Assinatura PAdES (PDF) com PKCS#12 (certificado pré-importado) (C#)
...
O serviço sobe em `http://localhost:5088`.
...
# 🇬🇧 SolidSign API - Integration Example: PAdES (PDF) Signing with PKCS#12 (pre-imported certificate) (C#)
...
The service starts on `http://localhost:5088`.
